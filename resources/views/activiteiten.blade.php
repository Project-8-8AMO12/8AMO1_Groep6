...
@section('content')
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light" id="activietenimg">
        <div class="col-md-5 p-lg-5 mx-auto my-5" >
            <h1 class="display-4 font-weight-normal">Activiteiten</h1>
        </div>
    </div>

    <div class="blog-post" >

        <h2>Koninginneteelt</h2>
        <hr>
